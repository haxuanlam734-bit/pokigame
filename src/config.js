...
const CONFIG = {
    ...
    LIGHTING: {
        ...
        sunset: {
            ...
            hemiSkyColor: '#b8a0a0',
            hemiGroundColor: '#6a5d4e',
            hemiIntensity: 0.06,
            sunPosition: { x: 590, y: 20, z: 800 },
            exposure: 0.92,
            saturation: 1.10,
            sunColor: '#ffe0b8',
            sunIntensity: 1.3,
        ...
        night: {
            ...
            hemiSkyColor: '#1e3050',
            hemiGroundColor: '#141e26',
            hemiIntensity: 0.35,
            sunPosition: { x: 800, y: -50, z: 800 },
            exposure: 0.85,
            saturation: 1.02,
            sunColor: '#8aa8c4',
            sunIntensity: 0.0,
            ...
            moonPosition: { x: 800, y: 110, z: 800 },
            moonIntensity: 0.60,
            moonColor: '#b8c8e0'
        },
        dawn: {
    ...
    SPECIAL_EVENT_CONFIG: {
        ...
        maxStartOffset: 120,
        eclipse: {
            zombieModifiers: { hp: 1.15, speed: 1.15, damage: 1.10, aggression: 1.20, detection: 1.35 },
            playerModifiers: { staminaRegen: 0.85 },
            rewardMultiplier: 1.15,
            sunIntensityMin: 0.20,
            sunIntensityMax: 0.35,
            peakDuration: 30,
            peakPulseDuration: 1.0,
            particleCount: 100,
            ribbonCount: 8,
            rayCount: 12,
            visualScaleMultiplier: 1.15
        },
        bloodMoon: {
            zombieModifiers: { hp: 1.50, speed: 1.25, damage: 1.35, aggression: 1.40, detection: 1.40 },
            playerModifiers: { staminaRegen: 0.70, staminaDrain: 1.15, healingEffectiveness: 0.90 },
            rewardMultiplier: 1.50,
            moonColor: '#8b0000',
            moonVisualScaleMultiplier: 1.15,
            particleCount: 50,
            pulseInterval: 30,
            pulseDuration: 10,
            pulseZombieBuff: { speed: 0.15, damage: 0.15 }
        }
    }
};
